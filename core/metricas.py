...
compartidas entre los generadores de dashboards.
...
def calcular_metricas_basicas(df: pd.DataFrame) -> Dict:
    ...
    Usada por los generadores de dashboards.
...
def calcular_metricas_consolidadas(df: pd.DataFrame) -> Dict:
    ...
    Usada principalmente por los dashboards consolidados.
